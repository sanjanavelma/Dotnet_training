...
//Create Cardiologist Child Classs that inherits Doctor Class.
//Give a call to the Parent class constructor
//print static member TotalDoctors
//print non-static members
public class Cardiologist : Doctor
{
    public Cardiologist(string name, int license) : base(name, "Cardiology", license)
    {
        Console.WriteLine($"Cardiologist Name: {Name}");
        Console.WriteLine($"Specialization: {Specialization}");
        Console.WriteLine($"License Number: {LicenseNumber}");
        Console.WriteLine($"Total Doctors Registered: {TotalDoctors}");
    }
}
